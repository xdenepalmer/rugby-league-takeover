...
export default function Register() {
  ...
  // Supabase Auth is configured to email an 8-digit confirmation code, so the
  // input must accept all 8 — a 6-slot field silently truncated the code and
  // every verification failed with "token invalid".
  const OTP_LENGTH = 8;
