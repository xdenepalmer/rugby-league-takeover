  ...
  return (
    <section id="merch" className="border-t border-border bg-background/80 px-5 py-24 md:px-8 md:py-32">
      <div className="mx-auto grid max-w-7xl gap-10 border border-border p-8 md:grid-cols-[1fr_auto] md:items-end md:p-12">
        <SectionHeader eyebrow={settings.merch_eyebrow || "Merch"} title={settings.merch_title || "Wear the takeover"}>
          {settings.merch_description || "Browse official Rugby League Takeover merch and checkout securely in AUD."}
        </SectionHeader>
