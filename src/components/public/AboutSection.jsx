    ...
    <section id="about" className="border-t border-border bg-secondary/80 px-5 py-24 md:px-8 md:py-32">
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="relative min-h-[520px] overflow-hidden border border-border">
          <img src={settings.about_image_url || "https://images.unsplash.com/photo-1569959220744-ff553533f492?auto=format&fit=crop&w=1400&q=80"} alt="Supporters celebrating" loading="lazy" className="absolute inset-0 h-full w-full object-cover grayscale" />
