...
export default function AuthLayout({ icon: Icon, title, subtitle, footer, children }) {
  return (
    <div className="min-h-dvh grid lg:grid-cols-2 bg-background relative overflow-hidden">
      ...
      <div className="flex max-h-dvh items-center justify-center overflow-y-auto p-6 sm:p-10 md:p-16 pt-[max(1.5rem,var(--safe-top))] pb-[max(1.5rem,var(--safe-bottom))] z-10 relative">
