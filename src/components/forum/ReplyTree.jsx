              ...
              {open && (
                <form onSubmit={(e) => onReply(reply, e)} className="mt-3 grid gap-2 border-t border-border/40 pt-3">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <Button type="submit" size="mobile" disabled={isSubmitting || !draft.body} className="rounded-none bg-primary text-[10px] uppercase tracking-wider hover:bg-primary/90">
