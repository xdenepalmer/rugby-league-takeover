...
export default function SlotMachineBadgeUnlock() {
  ...
  const finishSpin = useCallback(() => {
    ...
    if (result.type === "win") {
      successImpact();
      // The server decides whether the badge was actually new — the local
      // award still runs so guests (and offline state) stay consistent.
    ...
    // A server spin changed chips/badges on the profile — refresh so the rank
      ...
      <div className="relative p-3 sm:p-5">
        ...
        <div className="relative overflow-hidden border border-purple-500/20 bg-black p-2.5 shadow-[inset_0_0_50px_rgba(0,0,0,0.98),0_0_30px_rgba(88,28,135,0.12)] sm:p-3">
          ...
          <div className="relative grid grid-cols-1 gap-2.5 xl:grid-cols-[1fr_auto] xl:gap-3">
            ...
            <Lever canSpin={canSpin} leverDown={leverDown} onPull={() => handleSpin("daily")} />
          </div>
